...
export const translations = {
  en: {
    ...
    colCountry: "Country",
    colTargetId: "Submitted Actions",
    colSection: "Progress Summary",
    colStatus: "Status",
    colStart: "Start",
    colEnd: "End",
    colId: "ID",
    ...
    reportMainTitle: "AFCAC — Revised Abuja Safety Targets",
    reportCountryBadge: "Country: {country}",
    reportGenerated: "Generated",
    reportTargetsSubtitle: "Safety Targets — Progress by Sub-target",
    reportCountryBreakdownSubtitle: "Country Breakdown — All African States",
    reportActionPlansSubtitle: "Action Plans — Per-Country Implementation Status",
    nAfricanStates: "{n} African States",
    implementationStatus: "Actions Initiated",
    colMetric: "Metric",
    colValue: "Value",
    colTitle: "Title",
    colRegion: "Region",
    colAuthorityEntity: "Authority/Entity",
    colTargetsTotal: "Targets Total",
    colTargets: "Targets",
    colPctDelayed: "% Delayed",
    colPctNotStarted: "% Not Started",
    colBudgetUsd: "Budget (USD)",
    colActionTarget: "Action / Target",
    colStartYear: "Start Year",
    colEndYear: "End Year",
    colDurationWeeks: "Duration (weeks)",
    colDurationWks: "Duration (wks)",
    totalBudget: "Total Budget (USD)",
    sheetKpiSummary: "KPI Summary",
    sheetSafetyTargets: "Safety Targets",
    sheetCountryBreakdown: "Country Breakdown",
    sheetActionPlans: "Action Plans",
    reportFooterSummary: "{c} countries · {t} targets · {a} action plans",
    ...
    // Admin client — users table & management
    ...
    confirmDeleteUser: "Confirm?",
    editUsername: "Username",
    toastUsernameTaken: "❌ Username already taken",
    btnAddUser: "Add User",
    addUserSubtitle: "Create a new user account",
    btnCreateUser: "Create User",
    countriesAssigned: "countries assigned",
    addUserRequired: "Please fill in required fields (name, username, password).",
    toastUserCreated: "✅ User created successfully!",
    placeholderFullName: "First Last",
    placeholderNewUsername: "firstname.lastname",
    ...
    adminIntroUpdates: "View all updates submitted by users — which targets were filled and when.",
  ...
  fr: {
    ...
    colCountry: "Pays",
    colTargetId: "Actions Soumises",
    colSection: "Résumé de Progression",
    colStatus: "Statut",
    colStart: "Début",
    colEnd: "Fin",
    colId: "ID",
    ...
    reportMainTitle: "AFCAC — Objectifs de Sécurité Révisés d'Abuja",
    reportCountryBadge: "Pays : {country}",
    reportGenerated: "Généré",
    reportTargetsSubtitle: "Objectifs de Sécurité — Progression par Sous-objectif",
    reportCountryBreakdownSubtitle: "Répartition par Pays — Tous les États Africains",
    reportActionPlansSubtitle: "Plans d'Action — Statut de Mise en Œuvre par Pays",
    nAfricanStates: "{n} États Africains",
    implementationStatus: "Actions Initiées",
    colMetric: "Indicateur",
    colValue: "Valeur",
    colTitle: "Titre",
    colRegion: "Région",
    colAuthorityEntity: "Autorité/Entité",
    colTargetsTotal: "Total Objectifs",
    colTargets: "Objectifs",
    colPctDelayed: "% Retardé",
    colPctNotStarted: "% Non démarré",
    colBudgetUsd: "Budget (USD)",
    colActionTarget: "Action / Objectif",
    colStartYear: "Année de début",
    colEndYear: "Année de fin",
    colDurationWeeks: "Durée (semaines)",
    colDurationWks: "Durée (sem.)",
    totalBudget: "Budget Total (USD)",
    sheetKpiSummary: "Résumé KPI",
    sheetSafetyTargets: "Objectifs de Sécurité",
    sheetCountryBreakdown: "Répartition par Pays",
    sheetActionPlans: "Plans d'Action",
    reportFooterSummary: "{c} pays · {t} objectifs · {a} plans d'action",
    ...
    statusBadgeDisabled: "DÉSACTIVÉ",
    accountProtected: "Compte protégé — ne peut pas être désactivé",
    ...
    toastAccountDisabled: "🚫 Compte désactivé",
    toastAccountEnabled: "✅ Compte activé",
    toastUserSaved: "✅ Utilisateur enregistré",
    toastUserDeleted: "✅ Utilisateur supprimé",
    btnDeleteUser: "Supprimer",
    confirmDeleteUser: "Confirmer?",
    editUsername: "Nom d'utilisateur",
    toastUsernameTaken: "❌ Nom d'utilisateur déjà utilisé",
    btnAddUser: "Ajouter un utilisateur",
    addUserSubtitle: "Créer un nouveau compte utilisateur",
    btnCreateUser: "Créer l'utilisateur",
    countriesAssigned: "pays assignés",
    addUserRequired: "Veuillez remplir les champs obligatoires (nom, identifiant, mot de passe).",
    toastUserCreated: "✅ Utilisateur créé avec succès !",
    placeholderFullName: "Prénom Nom",
    placeholderNewUsername: "prenom.nom",
    placeholderPassword: "Mot de passe",
    placeholderEmail: "email@domaine.com",
    toastSaved: "✓ Tableau de bord mis à jour",
    toastSaveError: "Erreur de sauvegarde",
    roleAdministrator: "Administrateur",
    roleFocalPointLabel: "Point Focal",
    navKpiLabel: "Aperçu KPI",
    navKpiSub: "Indicateurs globaux",
    navTargetsLabel: "Objectifs Sécurité",
    navTargetsSub: "39 objectifs AFCAC",
    navActionsLabel: "Plan d'Action",
    navActionsSub: "Actions pays",
    navCountriesLabel: "Données Pays",
    navCountriesSub: "Pays",
    navUsersLabel: "Accès États",
    ...
    sessionsNoneHistory: "Aucune session enregistrée.",
    sessionsConnectedOn: "Connecté le",
    sessionsAt: "à",
    sessionsActive: "Actif",
    sessionsOnlineStatus: "🟢 En ligne",
    sessionsOfflineStatus: "⚪ Déconnecté",
    sessionsRefresh: "Rafraîchir",
    colUser: "Utilisateur",
    colLogin: "Connexion",
    colLogout: "Déconnexion",
    colDuration: "Durée",
    ...
    adminIntroUpdates: "Visualisez toutes les mises à jour soumises par les utilisateurs — quels objectifs ont été renseignés et quand.",
  ...
  pt: {
    ...
    colCountry: "País",
    colTargetId: "Ações Submetidas",
    colSection: "Resumo do Progresso",
    colStatus: "Status",
    colStart: "Início",
    colEnd: "Fim",
    colId: "ID",
    ...
    reportMainTitle: "AFCAC — Metas de Segurança Revistas de Abuja",
    reportCountryBadge: "País: {country}",
    reportGenerated: "Gerado",
    reportTargetsSubtitle: "Metas de Segurança — Progresso por Sub-meta",
    reportCountryBreakdownSubtitle: "Repartição por País — Todos os Estados Africanos",
    reportActionPlansSubtitle: "Planos de Ação — Estado de Implementação por País",
    nAfricanStates: "{n} Estados Africanos",
    implementationStatus: "Ações Iniciadas",
    colMetric: "Métrica",
    colValue: "Valor",
    colTitle: "Título",
    colRegion: "Região",
    colAuthorityEntity: "Autoridade/Entidade",
    colTargetsTotal: "Total de Metas",
    colTargets: "Metas",
    colPctDelayed: "% Atrasado",
    colPctNotStarted: "% Não Iniciado",
    colBudgetUsd: "Orçamento (USD)",
    colActionTarget: "Ação / Meta",
    colStartYear: "Ano de início",
    colEndYear: "Ano de fim",
    colDurationWeeks: "Duração (semanas)",
    colDurationWks: "Duração (sem.)",
    totalBudget: "Orçamento Total (USD)",
    sheetKpiSummary: "Resumo KPI",
    sheetSafetyTargets: "Metas de Segurança",
    sheetCountryBreakdown: "Repartição por País",
    sheetActionPlans: "Planos de Ação",
    reportFooterSummary: "{c} países · {t} metas · {a} planos de ação",
    ...
    accountProtected: "Conta protegida — não pode ser desativada",
    ...
    searchUserPlaceholder: "🔍 Pesquisar utilizador, país…",
    editingUser: "Editando:",
    noUsersFound: "Nenhum utilizador corresponde à pesquisa.",
    toastAccountDisabled: "🚫 Conta desativada",
    toastAccountEnabled: "✅ Conta ativada",
    toastUserSaved: "✅ Utilizador guardado",
    toastUserDeleted: "✅ Utilizador eliminado",
    btnDeleteUser: "Eliminar",
    confirmDeleteUser: "Confirmar?",
    editUsername: "Nome de utilizador",
    toastUsernameTaken: "❌ Nome de utilizador já utilizado",
    btnAddUser: "Adicionar utilizador",
    addUserSubtitle: "Criar nova conta de utilizador",
    btnCreateUser: "Criar utilizador",
    countriesAssigned: "países atribuídos",
    addUserRequired: "Por favor preencha os campos obrigatórios (nome, utilizador, palavra-passe).",
    toastUserCreated: "✅ Utilizador criado com sucesso!",
    placeholderFullName: "Nome Apelido",
    placeholderNewUsername: "nome.apelido",
    ...
    navKpiLabel: "Visão KPI",
    navKpiSub: "Indicadores globais",
    navTargetsLabel: "Metas de Segurança",
    navTargetsSub: "39 metas AFCAC",
    navActionsLabel: "Plano de Ação",
    navActionsSub: "Ações dos países",
    navCountriesLabel: "Dados dos Países",
    navCountriesSub: "Países",
    navUsersLabel: "Acesso Estados",
    navUsersSub: "Pontos Focais",
    navSessionsLabel: "Utilizadores",
    navSessionsSub: "Online & histórico",
    sessionsOnlineTab: "🟢 Online",
    sessionsHistoryTab: "🕐 Histórico",
    sessionsLoading: "Carregando…",
    sessionsNoneOnline: "Nenhum utilizador online no momento.",
    sessionsNoneHistory: "Nenhuma sessão registada.",
    ...
    adminTabUpdatesTitle: "Registo de Atividade de Atualizações",
    adminIntroUpdates: "Veja todas as atualizações enviadas pelos utilizadores — quais objetivos foram preenchidos e quando.",
  ...
  ar: {
    ...
    colCountry: "الدولة",
    colTargetId: "الإجراءات المُقدَّمة",
    colSection: "ملخص التقدم",
    colStatus: "الحالة",
    colStart: "البداية",
    colEnd: "النهاية",
    colId: "المعرّف",
    ...
    reportMainTitle: "أفكاك - أهداف سلامة أبوجا المعدّلة",
    reportCountryBadge: "الدولة: {country}",
    reportGenerated: "تم الإنشاء",
    reportTargetsSubtitle: "أهداف السلامة - التقدم حسب الهدف الفرعي",
    reportCountryBreakdownSubtitle: "توزيع حسب الدولة - جميع الدول الأفريقية",
    reportActionPlansSubtitle: "خطط العمل - حالة التنفيذ لكل دولة",
    nAfricanStates: "{n} دولة أفريقية",
    implementationStatus: "الإجراءات التي بدأت",
    colMetric: "المؤشر",
    colValue: "القيمة",
    colTitle: "العنوان",
    colRegion: "المنطقة",
    colAuthorityEntity: "الجهة/الهيئة",
    colTargetsTotal: "إجمالي الأهداف",
    colTargets: "الأهداف",
    colPctDelayed: "% متأخر",
    colPctNotStarted: "% لم يبدأ",
    colBudgetUsd: "الميزانية (دولار أمريكي)",
    colActionTarget: "الإجراء / الهدف",
    colStartYear: "سنة البداية",
    colEndYear: "سنة النهاية",
    colDurationWeeks: "المدة (أسابيع)",
    colDurationWks: "المدة (أسبوع)",
    totalBudget: "إجمالي الميزانية (دولار أمريكي)",
    sheetKpiSummary: "ملخص المؤشرات",
    sheetSafetyTargets: "أهداف السلامة",
    sheetCountryBreakdown: "توزيع حسب الدولة",
    sheetActionPlans: "خطط العمل",
    reportFooterSummary: "{c} دولة · {t} هدف · {a} خطة عمل",
    ...
    btnDeleteUser: "حذف",
    confirmDeleteUser: "تأكيد؟",
    editUsername: "اسم المستخدم",
    toastUsernameTaken: "❌ اسم المستخدم مستخدم بالفعل",
    btnAddUser: "إضافة مستخدم",
    addUserSubtitle: "إنشاء حساب مستخدم جديد",
    btnCreateUser: "إنشاء المستخدم",
    countriesAssigned: "دول مخصصة",
    addUserRequired: "يرجى ملء الحقول المطلوبة (الاسم، اسم المستخدم، كلمة المرور).",
    toastUserCreated: "✅ تم إنشاء المستخدم بنجاح!",
    placeholderFullName: "الاسم الكامل",
    placeholderNewUsername: "الاسم.اللقب",
    ...
    navUpdatesSub: "تاريخ التحديثات",
    adminTabUpdatesTitle: "سجل نشاط التحديثات",
    adminIntroUpdates: "عرض جميع التحديثات المقدمة من المستخدمين — الأهداف التي تم تحديثها ومتى.",
    colDateTime: "التاريخ والوقت",
    colTargetsCount: "الأهداف",
    colTargetIds: "معرّفات الأهداف",
